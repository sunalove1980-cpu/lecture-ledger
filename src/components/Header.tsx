    ...
    <header className="border-b border-[#d9d5c9] bg-[#f3f0e8]/95 backdrop-blur-xl">
      <div className="mx-auto flex h-[72px] max-w-7xl items-center justify-between gap-3 px-4 sm:px-7">
        <div className="flex min-w-0 items-center gap-3">
          <div className="grid h-10 w-10 shrink-0 place-items-center bg-[#171916] text-sm font-black tracking-[-0.08em] text-[#d8c7a8]">LL</div>
        ...
        <div className="flex shrink-0 items-center gap-1.5">
          ...
          <button onClick={onOpenNewLectureModal} className="flex h-10 items-center gap-2 bg-[#69735f] px-3.5 text-xs font-black text-white transition hover:bg-[#596250] active:translate-y-px"><Plus className="h-4 w-4 stroke-[2.5]" /><span className="hidden sm:inline">새 강의</span></button>
        </div>
      </div>
    </header>
  );
